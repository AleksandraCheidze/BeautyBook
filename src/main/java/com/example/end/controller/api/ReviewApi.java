...
public interface ReviewApi {
        ...
        @Operation(summary = "Get reviews by master.Available to all users", description = "Public")
        ...
        @Operation(summary = "Get rating of a master.Available to all users", description = "Public")
        @GetMapping
                ("/rating/{masterId}")
